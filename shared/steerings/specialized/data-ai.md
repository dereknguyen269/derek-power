...
|-------|------|---------|-------------|
| **AI Engineer** | `data-ai/ai-engineer.md` | LLM apps, RAG systems | AI-powered applications |
| **Data Engineer** | `data-ai/data-engineer.md` | ETL/ELT, data pipelines | Data infrastructure |
| **Data Scientist** | `data-ai/data-scientist.md` | SQL, BigQuery, analytics | Data analysis, insights |
| **Database Optimizer** | `data-ai/database-optimizer.md` | Query & schema optimization | Performance tuning |
| **GraphQL Architect** | `data-ai/graphql-architect.md` | GraphQL API design | GraphQL projects |
| **ML Engineer** | `data-ai/ml-engineer.md` | MLOps, model deployment | Production ML systems |
| **PostgreSQL Pro** | `data-ai/postgres-pro.md` | PostgreSQL, PgLite | Postgres optimization |
| **Prompt Engineer** | `data-ai/prompt-engineer.md` | LLM prompting, agentic AI | Prompt optimization |
