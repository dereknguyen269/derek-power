...
|-------|------|---------|-------------|
| **Rails Backend Expert** | `rails/rails-backend-expert.md` | Full-stack Rails development | Rails apps, MVC patterns |
| **Rails API Developer** | `rails/rails-api-developer.md` | Rails API development | REST APIs, JSON:API, GraphQL |
| **Rails ActiveRecord Expert** | `rails/rails-activerecord-expert.md` | Database & ORM optimization | Models, queries, migrations |
