...
|-------|------|---------|-------------|
| **Project Analyst** | `project-analyst.md` | Rapid tech stack detection | New/unfamiliar codebases |
| **Tech Lead Orchestrator** | `tech-lead-orchestrator.md` | Strategic task orchestration | Multi-step tasks, feature implementation |
| **Team Configurator** | `team-configurator.md` | AI team setup & configuration | New repos, tech stack changes |

## Agent Details

### Project Analyst
**File**: `#[[file:project-analyst.md]]`
...
**File**: `#[[file:tech-lead-orchestrator.md]]`
...
### Team Configurator
**File**: `#[[file:team-configurator.md]]`
...
```
New Project:        project-analyst.md → team-configurator.md
Complex Feature:    tech-lead-orchestrator.md
Stack Detection:    project-analyst.md
Team Setup:         team-configurator.md
```
