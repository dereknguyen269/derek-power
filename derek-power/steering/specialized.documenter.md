...
|-------|------|---------|-------------|
| **API Documenter** | `specialized.api-documenter.md` | OpenAPI specs, API docs | REST API documentation |
| **Documentation Expert** | `specialized.documentation-expert.md` | Technical writing, guides | General documentation |
