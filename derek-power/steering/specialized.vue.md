...
|-------|------|---------|-------------|
| **Vue Component Architect** | `specialized.vue-component-architect.md` | Vue 3 Composition API & patterns | Component design, composables |
| **Vue Nuxt Expert** | `specialized.vue-nuxt-expert.md` | Nuxt.js full-stack development | SSR, SSG, Nuxt apps |
| **Vue State Manager** | `specialized.vue-state-manager.md` | State management patterns | Pinia, Vuex, complex state |
