...
└─────────────────────────────────────────────────────────────────────────────┘
            ...
            └───────────┘                   └───────────────┘
                    ...
                    ▼                               ▼
    ┌───────────────────────────┐   ┌───────────────────────────────┐
    │     QUICK PLANNING        │   │   FOLDER SPEC PLANNING        │
...
| Memory File | Purpose | Relationship to Folder Specs |
|-------------|---------|----------------------|
| `PROJECT.md` | Project overview and architecture | Referenced by all folder specs |
| `PROGRESS.md` | Quick task tracking | Links to active folder specs |
| `DECISIONS.md` | Global decision log | Folder specs reference for consistency |
| `KNOWLEDGE.md` | Patterns and learnings | Updated from folder spec implementations |
| `SCRATCHPAD.md` | Temporary session notes | Working area during spec work |

**Folder specs** (`.kiro/features/<spec-name>/`) contain spec-specific planning:
- Self-contained specification documentation
- Isolated from other specs
...
### For Complex Specs (Folder Spec Planning)
```
1. Create folder spec: `.kiro/features/<spec-name>/`
...
# Part 2: Folder Spec Planning Development

## When to Use Folder Spec Planning
...
│   ├── PROJECT.md
│   ├── PROGRESS.md              # Links to active folder specs
│   ├── DECISIONS.md
│   ├── KNOWLEDGE.md             # Finalized learnings (from completed specs)
│   └── SCRATCHPAD.md
│
...
The `notes.md` file captures knowledge **during** implementation before the spec is complete:
...
When user requests a new spec, follow this workflow:

### Step 1: Create Folder Spec
```bash
...
## Linking Folder Specs to Project Memory

### Update PROGRESS.md
When working on a folder spec, update the global progress file:
...
### Update KNOWLEDGE.md
After completing a folder spec, transfer learnings:
...
## File References in Folder Specs

Folder specs can reference other files using the `#[[file:path]]` syntax:
...
- Keep folder specs focused and manageable
...
### 5. Keep Folder Specs Self-Contained
- Each folder spec should be understandable on its own
...
**The time invested in folder spec planning is recovered many times over through:**
