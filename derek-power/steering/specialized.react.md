...
|-------|------|---------|-------------|
| **React Component Architect** | `specialized.react-component-architect.md` | Component design & patterns | Component libraries, design systems |
| **React Next.js Expert** | `specialized.react-nextjs-expert.md` | Next.js full-stack development | Next.js apps, SSR, App Router |
